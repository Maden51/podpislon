    ...
    <ImageLayout backgroundUrl="url('../src/assets/images/image-layout-2.png')" pseudoClass="" bgColor="bg-[F2F2F2]">
      <PageLayout>
        <div className="pt-20 pb-24 mb-24">
          <h2 className=" font-sansBold text-[52px] leading-none text-white max-w-4xl mb-5">Менеджер отправляет договор на подпись из нашего прилождения в Битрикс24</h2>
          <form>
